...
namespace YcyTv.Renderers
{
    public class VideoPlayer : View
    {
        ...
        /// </summary>
        public IVideoPlayerRenderer NativeRenderer;
        ...
        /// </summary>
        public static readonly BindablePropertyKey StatePropertyKey =
            BindableProperty.CreateReadOnly(nameof(State), typeof(PlayerState), typeof(VideoPlayer), PlayerState.Idle);
        ...
        /// </summary>
        public static readonly BindablePropertyKey CurrentTimePropertyKey =
        ...
        public static readonly BindableProperty VideoTitleProperty =
            BindableProperty.Create(nameof(VideoTitle), typeof(string), typeof(VideoPlayer), "");
        ...
        /// </summary>
        public static readonly BindableProperty DisplayControlsProperty =
            BindableProperty.Create(nameof(DisplayControls), typeof(bool), typeof(VideoPlayer), true);
        ...
        public static readonly BindableProperty FillModeProperty = BindableProperty.Create(nameof(FillMode),
            typeof(FillMode), typeof(VideoPlayer), FillMode.ResizeAspect);
        ...
        /// </summary>
        public static readonly BindableProperty TimeElapsedIntervalProperty =
            BindableProperty.Create(nameof(TimeElapsedInterval), typeof(int), typeof(VideoPlayer), 0);
        ...
        public static readonly BindableProperty RepeatProperty =
            BindableProperty.Create(nameof(Repeat), typeof(bool), typeof(VideoPlayer), false);
        ...
        public static readonly BindableProperty VolumeProperty =
            BindableProperty.Create(nameof(Volume), typeof(int), typeof(VideoPlayer), int.MinValue);
        ...
        /// </summary>
        /// <param name="e">The <see cref="VideoPlayerEventArgs"/> instance containing the event data.</param>
        public void OnTimeElapsed(VideoPlayerEventArgs e)
        {
            TimeElapsed.RaiseEvent(this, e);
        }
        ...
        /// </summary>
        /// <param name="e">The <see cref="VideoPlayerEventArgs"/> instance containing the event data.</param>
        public void OnCompleted(VideoPlayerEventArgs e)
        {
        ...
        public static readonly BindableProperty PauseCommandProperty =
            BindableProperty.Create(nameof(PauseCommand), typeof(ICommand), typeof(VideoPlayer), null);
        ...
        public static readonly BindableProperty SeekCommandProperty =
            BindableProperty.Create(nameof(SeekCommand), typeof(ICommand), typeof(VideoPlayer), null);
        ...
        /// </summary>
        /// <param name="source">The video source.</param>
        public VideoPlayer(VideoSource source)
        {
            Source = source;
        }
        ...
        {
            return NativeRenderer?.OnBackPressed() ?? false;
        }
